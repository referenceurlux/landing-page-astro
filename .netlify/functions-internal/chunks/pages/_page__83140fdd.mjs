...
const $$Galerie = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const page = await WordpressServices.getPageBySlug(slug);
  const template = page.acf.template;
  return renderTemplate`${maybeRenderHead()}<section class="py-20 relative"><div class="container mx-auto"><span class="font-montserrat text-[--secondary-color] opacity-50 -z-1 absolute left-1/2 -translate-x-1/2 top-0 text-6xl lg:text-9xl font-bold uppercase">${page.acf.gros_titre_galerie}</span><div class="font-montserrat font-semibold text-2xl md:text-5xl text-center mb-20">${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(page.acf.petit_titre_galerie)}` })}</div><div class="grid grid-cols-12 gap-4"><div${addAttribute(`col-span-12 md:col-span-8 overflow-hidden ${template === "Template 3" ? "rounded-3xl" : ""}`, "class")}><img class="w-full h-full object-cover aspect-video"${addAttribute(page.acf.image_1_galerie.url, "src")}${addAttribute(page.acf.image_1_galerie.description, "alt")}></div><div${addAttribute(`col-span-12 md:col-span-4 overflow-hidden ${template === "Template 2" ? "rounded-3xl" : ""}`, "class")}><img class="w-full h-full object-cover aspect-square"${addAttribute(page.acf.image_2_galerie.url, "src")}${addAttribute(page.acf.image_2_galerie.description, "alt")}></div><div${addAttribute(`col-span-12 md:col-span-4 overflow-hidden ${template === "Template 2" ? "rounded-3xl" : ""}`, "class")}><img class="w-full h-full object-cover aspect-square"${addAttribute(page.acf.image_3_galerie.url, "src")}${addAttribute(page.acf.image_3_galerie.description, "alt")}></div><div${addAttribute(`col-span-12 md:col-span-4 overflow-hidden ${template === "Template 2" ? "rounded-3xl" : ""}`, "class")}><img class="w-full h-full object-cover aspect-square"${addAttribute(page.acf.image_4_galerie.url, "src")}${addAttribute(page.acf.image_4_galerie.description, "alt")}></div><div${addAttribute(`col-span-12 md:col-span-4 overflow-hidden ${template === "Template 2" ? "rounded-3xl" : ""}`, "class")}><img class="w-full h-full object-cover aspect-square"${addAttribute(page.acf.image_5_galerie.url, "src")}${addAttribute(page.acf.image_5_galerie.description, "alt")}></div><div${addAttribute(`col-span-12 md:col-span-4 overflow-hidden ${template === "Template 2" ? "rounded-3xl" : ""}`, "class")}><img class="w-full h-full object-cover aspect-square"${addAttribute(page.acf.image_6_galerie.url, "src")}${addAttribute(page.acf.image_6_galerie.description, "alt")}></div><div${addAttribute(`col-span-12 md:col-span-8 overflow-hidden ${template === "Template 2" ? "rounded-3xl" : ""}`, "class")}><img class="w-full h-full object-cover aspect-video"${addAttribute(page.acf.image_7_galerie.url, "src")}${addAttribute(page.acf.image_7_galerie.description, "alt")}></div></div></div></section>`;
...
const $$HeroSwitcher = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const page = await WordpressServices.getPageBySlug(slug);
  const template = page.acf.template;
  return renderTemplate`${template === "Template 1" ? renderTemplate`${renderComponent($$result, "Hero", $$Hero, { "slug": page.slug })}` : null}${template === "Template 3" ? renderTemplate`${renderComponent($$result, "Hero3", $$Hero3, { "slug": page.slug })}` : null}`;
...
const $$page = createComponent(async ($$result, $$props, $$slots) => {
  ...
  currentPage.acf.template;
  if (!page)
    return Astro2.redirect("/404");
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": page.slug }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Header", $$Header, { "slug": page.slug })}${renderComponent($$result2, "HeroSwitcher", $$HeroSwitcher, { "slug": page.slug })}${renderComponent($$result2, "About", $$About, { "slug": page.slug })}${renderComponent($$result2, "Infos", $$Infos, { "slug": page.slug })}${renderComponent($$result2, "Cta", $$Cta, { "slug": page.slug })}${renderComponent($$result2, "Galerie", $$Galerie, { "slug": page.slug })}${renderComponent($$result2, "Contact", $$Contact, { "slug": page.slug })}${renderComponent($$result2, "Footer", $$Footer, { "slug": page.slug })}` })}`;
